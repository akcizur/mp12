...
function warehouseEscape(value) {
          ...
          return `<article class="warehouse-box-card">
            <header class="warehouse-box-head">
              <div>
                ...
                <strong>${warehouseEscape(boxId)}</strong>
              </div>
            ...
            <div class="warehouse-pack-list">
              ${boxPacks.map((pack) => `<div class="warehouse-pack-row">
                <span class="warehouse-pack-id">${warehouseEscape(pack.id)}</span>
                <span class="warehouse-pack-name">${warehouseEscape(materialNames.get(String(pack.material)) || pack.material || 'Neznámá surovina')}</span>
